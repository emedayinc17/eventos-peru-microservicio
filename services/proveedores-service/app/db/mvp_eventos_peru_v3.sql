...
SET password_hash = '$2b$12$Q.DCX/Ttbd2uWo8QNGw/LeRcSUpgP1oGN4Rz18mcFpMV0tXIi5Ziy'
WHERE email = 'demo@eventos.pe';
...
/* ============================================================
   ...
   ============================================================ */
CREATE USER IF NOT EXISTS 'app_iam'@'%'            IDENTIFIED BY 'IAM@2025!';
CREATE USER IF NOT EXISTS 'app_catalogo'@'%'       IDENTIFIED BY 'Cat@2025!';
CREATE USER IF NOT EXISTS 'app_paquetes'@'%'       IDENTIFIED BY 'Pkg@2025!';
CREATE USER IF NOT EXISTS 'app_proveedores'@'%'    IDENTIFIED BY 'Prov@2025!';
CREATE USER IF NOT EXISTS 'app_contratacion'@'%'   IDENTIFIED BY 'Contr@2025!';
